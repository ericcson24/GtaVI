  ...
  {!buscarActivo ? (
    ...
    <input
      ...
      onKeyDown={(e) => {
        if (e.key === "Enter") {
          if (busqueda.trim()) {
            location.href = `/personaje/${encodeURIComponent(busqueda.toLowerCase())}`;
